        ...
        <ul class="menu-main navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li>
                <a class="dropdown-item{{ if $active }} active{{ end }}" href="{{ .URL }}" {{ if $active }}aria-current="true" {{ end }}>
                  {{ .Name }}
                </a>
              </li>
              {{ end -}}
          ...
          {{ else }}
          <li class="nav-item">
            <a class="nav-link{{ if $active }} active{{ end }}" aria-current="page" href="{{ .URL }}">{{ .Name }}</a>
          </li>
          {{ end }}
          {{ end -}}
        </ul>
          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarLanguageDropdown">
                ...
                <li>
                  <a class="dropdown-item" rel="alternate" href="{{ .Lang | relLangURL }}" hreflang="{{ .Lang }}" lang="{{ .Lang }}">
                    {{ .LanguageName }}
                  </a>
                </li>
                {{ end -}}
